...
async def on_message(message):
    ...
    await message.channel.send(">>> Yo to you {}. Feel free to ask for help by typing the command !help".format(author))
    ...
    if message.content.startswith('!cryptolist reset'):
        # Reset stocks watchlist
        response = methods.reset_stock_to_follow('stocks')
    ...
    if message.content.startswith('!cryptolist reset'):
        # Reset crypto watchlist
        response = methods.reset_stock_to_follow('crypto')
